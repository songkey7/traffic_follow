...
def get_symbols():
    ...
    url = MARKET_URL + '/v1/hadax/common/symbols'
    params = {}
    return http_get_request(url, params)
...
if __name__ == '__main__':
    #print get_symbols()
    #print get_history_trade('gsceth', 100)
    print get_kline('gsceth', '1min', 120)
    #print get_depth('gsceth', 'step0')
